...
def train_one_epoch(eeg_branch, stim_branch, temp_branch, dual_attn, corrector,
    ...
    for eeg, label, subj in dataloader:
        ...
        # Align EEG and corrected Stimulus features
...
def evaluate(eeg_branch, stim_branch, temp_branch, dual_attn, corrector,
    ...
    for eeg, label, subj in dataloader:
        ...
        for cls_idx, freq_val in zip(candidate_indices, candidate_freqs):
            # Prepare candidate frequency
            f_batch = freq_val.view(1).expand(B)

            # Frequency Auto Correction
            # Predict "What is the actual frequency if this EEG belongs to class k?"
            corrected_f_batch, _ = corrector(eeg, f_batch)

            # Stimulus Feature (Use corrected frequency)
            ...
            # Extract score for current class
...
def main(args):
    ...
    print(f"\n=======================================================")
    print(f" [LOSO] Lee2019 with Forced Stimulus Auto Corrector")
    print(f"=======================================================\n")
    ...
    for test_subj in subjects:
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            if test_acc > best_acc:
                ...
                save_path = os.path.join(save_dir, f"LOSOStimAutoCorrLee2019_sub{test_subj}_{ch_tag}.pth")
