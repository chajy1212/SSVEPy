...
from data_loader import ExpLee2019Dataset
...
def main(args):
    ...
    for subj in subjects:
        ...
        # TensorBoard writer
        writer = SummaryWriter(log_dir=f"/home/brainlab/Workspace/jycha/SSVEP/runs/ExpLee2019_Sub{subj}_EEGNet_{ch_tag}")

        train_dataset = ExpLee2019Dataset(subjects=[subj], train=True, pick_channels=args.pick_channels)
        test_dataset = ExpLee2019Dataset(subjects=[subj], train=False, pick_channels=args.pick_channels)
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            if test_acc > best_acc:
                ...
                save_path = os.path.join(save_dir, f"ExpLee2019_Sub{subj}_EEGNet_{ch_tag}.pth")
