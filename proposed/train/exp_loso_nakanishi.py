...
from data_loader import ExpNakanishi2015Dataset
...
def train_one_epoch(eeg_branch, stim_branch, temp_branch, dual_attn,
    ...
    for eeg, label, nominal_freq in dataloader:
...
def main(args):
    ...
    for test_subj in subjects:
        ...
        writer = SummaryWriter(log_dir=f"/home/brainlab/Workspace/jycha/SSVEP/runs/ExpLOSONakanishi2015_sub{test_subj}_EEGNet_{ch_tag}")

        # Dataset
        train_set = ExpNakanishi2015Dataset(subjects=train_subjs, pick_channels=args.pick_channels)
        test_set = ExpNakanishi2015Dataset(subjects=[test_subj], pick_channels=args.pick_channels)
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            if test_acc > best_acc:
                ...
                save_path = os.path.join(save_dir, f"ExpLOSONakanishi2015_sub{test_subj}_EEGNet_{ch_tag}.pth")
