...
def compute_itr(acc, n_classes, trial_time, eps=1e-12):
    ...
    acc = np.clip(acc, 1e-6, 1 - 1e-6)  # avoid log(0)
...
def main(args):
    ...
    for test_subj in subjects:
        ...
        writer = SummaryWriter(log_dir=f"/home/brainlab/Workspace/jycha/SSVEP/ablation/LOSO/eegnet_dtn/runs/Lee2019_Sub{test_subj}_EEGNet_{ch_tag}")
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            if test_acc > best_acc:
                ...
                # Save Model
                save_dir = "/home/brainlab/Workspace/jycha/SSVEP/ablation/LOSO/eegnet_dtn/model_path"
