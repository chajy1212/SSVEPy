...
from simple_attention import SimpleAttention_EEG_Stimulus
...
# ===== Train / Eval =====
def train_one_epoch(eeg_branch, stim_branch, attn_module, dataloader,
...
@torch.no_grad()
def evaluate(eeg_branch, stim_branch, attn_module, dataloader,
...
def main(args):
    ...
    for test_subj in subjects:
        ...
        writer = SummaryWriter(log_dir=f"/home/brainlab/Workspace/jycha/SSVEP/ablation/LOSO/eegnet_stim/runs/Lee2019_Sub{test_subj}_EEGNet_{ch_tag}")
        ...
        attn_module = SimpleAttention_EEG_Stimulus(d_eeg=eeg_branch.out_dim,
                                                   d_query=args.d_query,
                                                   d_model=args.d_model,
                                                   n_classes=n_classes).to(device)

        print_total_model_size(eeg_branch, stim_branch, attn_module)

        params = list(eeg_branch.parameters()) + list(stim_branch.parameters()) + list(attn_module.parameters())
        ...
        for epoch in range(1, args.epochs + 1):
            train_loss, train_acc = train_one_epoch(
                eeg_branch, stim_branch, attn_module,
            ...
            if test_acc > best_acc:
                ...
                # Save Model
                save_dir = "/home/brainlab/Workspace/jycha/SSVEP/ablation/LOSO/eegnet_stim/model_path"
