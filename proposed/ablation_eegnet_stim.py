...
def train_one_epoch(eeg_branch, stim_branch, attn_module, dataloader,
    ...
    for eeg, label in dataloader:
        ...
        stim_feat = stim_branch(eeg, label)             # (B, D_query)
...
def evaluate(eeg_branch, stim_branch, attn_module, dataloader,
    ...
    for eeg, label in dataloader:
        ...
        stim_feat = stim_branch(eeg, label)
        logits, _ = attn_module(eeg_feat, stim_feat)
...
def main(args):
    ...
    for test_subj in subjects:
        ...
        writer = SummaryWriter(
            log_dir=f"/home/brainlab/Workspace/jycha/SSVEP/ablation/eegnet_stim/runs/Nakanishi2015_sub{test_subj}_EEGNet_{ch_tag}")
