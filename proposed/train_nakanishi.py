...
def main(args):
    ...
    # TensorBoard writer
    writer = SummaryWriter(log_dir=f"/home/brainlab/Workspace/jycha/SSVEP/runs/Nakanishi2015_{args.subjects}_EEGNet_{ch_tag}")
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if test_acc > best_acc:
            ...
            save_path = os.path.join(save_dir, f"Nakanishi2015_{args.subjects}_EEGNet_{ch_tag}.pth")
